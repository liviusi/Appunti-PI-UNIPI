...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.7\textwidth]{src/immagini/interfaccia.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.9\textwidth]{src/immagini/tesla.jpg}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.9\textwidth]{src/immagini/flora_video.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=\textwidth]{src/immagini/standard-virtual-interfaces.png}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=\textwidth]{src/immagini/react.jpg}
