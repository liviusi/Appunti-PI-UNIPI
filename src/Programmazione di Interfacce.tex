...
\include{src/capitoli/capitolo_1} %introduzione
...
%\include{src/capitoli/capitolo_5} %Le interfacce utente
%\include{src/capitoli/capitolo_6} %Progettazione delle interfacce
%\include{src/capitoli/capitolo_7} %Principi Fondamentali dell'Interazione
%\include{src/capitoli/capitolo_8} %Constraints, Discoverability e Feedback
%\include{src/capitoli/capitolo_9} %How do people do things
%\include{src/capitoli/capitolo_10}
%\include{src/capitoli/capitolo_11}
